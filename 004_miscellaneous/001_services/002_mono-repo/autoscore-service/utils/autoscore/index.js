...
const created_autoscore = async (body) => {
    console.log('\n\n\n', {'=== BODY ===':body}, '\n\n\n');
    if (body) {
        if(body.assignment.source.toLowerCase() == 'assign' || body.assignment.item_number == 0) {
            body.assignment.item_number = 0;
            console.log('\n\n\n', 'ASSIGN', '\n\n\n');
        } else if(body.assignment.source.toLowerCase() == 'forum' || body.assignment.item_number == 1) {
            console.log('\n\n\n', 'FORUM', '\n\n\n');
            body.assignment.item_number = 1;
        }
    }
...
const findOrCreate_grade_sending = async (grade_receiver_row, institution, process_status) => {
    ...
    console.log('\n\n\n', {'ASSIGNMENT': grade_receiver_row.assignment}, '\n\n\n');
