module.exports = [{
  ...
  },
  {
    ...
    abbreviation: "UNIB",
    domain: "unib.org",
    token: "b62be43c04dadbe4352a1e170b39a91e",
    website: "https://team-accion.ctdesarrollo.org/michael-alejandro/moodle/moodle/my/",
    rest_path: "/webservice/rest/server.php",
    modality: 'virtual',
    translations: JSON.stringify({
    ...
    campus_uuid : "1a8e759c-e427-4d00-94f2-4b4d16b3a893",
    created_at: new Date(),
    updated_at: new Date()
  },
  {
