...
$THEME->name = 'adrian';        // name de nuestro theme    <--
...
$THEME->parents = ['boost'];        // theme del q extiende     <--
...
// // // // W con SCSS adicional para nuestro theme (Sass)
...
$THEME->scss = function ($theme) {
    return theme_adrian_get_main_scss_content($theme);
};
